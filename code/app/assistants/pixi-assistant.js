function PixiAssistant() {
}

PixiAssistant.prototype.setup = function() {
	...
	// references
	this.sixth = this.controller.get("pixi-sixthString");
	this.fifth = this.controller.get("pixi-fifthString");
	this.fourth = this.controller.get("pixi-fourthString");
	this.third = this.controller.get("pixi-thirdString");
	this.second = this.controller.get("pixi-secondString");
	this.first = this.controller.get("pixi-firstString");
	this.standard = this.controller.get("pixi-standard");
	this.droppedD = this.controller.get("pixi-droppedD");
	this.pro = this.controller.get("pixi-pro");
	this.standardOverlay = this.controller.get("pixi-standard-overlay");
	this.droppedDOverlay = this.controller.get("pixi-droppedD-overlay");
	this.onOverlay = this.controller.get("pixi-onOverlay");
...
PixiAssistant.prototype.activate = function(event) {
}
PixiAssistant.prototype.deactivate = function(event) {
}

PixiAssistant.prototype.cleanup = function(event) {
...
PixiAssistant.prototype.mediaSetup = function() {
...
PixiAssistant.prototype.switchTuning = function(tune) {
...
PixiAssistant.prototype.mediaHandleEvent = function(event){
	try{
...
PixiAssistant.prototype.sixthTap = function (event) {
	this.playMp3(this.sixthmp3,6);
}

PixiAssistant.prototype.fifthTap = function (event) {
	this.playMp3(this.fifthmp3,5);
}

PixiAssistant.prototype.fourthTap = function (event) {
	this.playMp3(this.fourthmp3,4);
}

PixiAssistant.prototype.thirdTap = function (event) {
	this.playMp3(this.thirdmp3,3);
}

PixiAssistant.prototype.secondTap = function (event) {
	this.playMp3(this.secondmp3,2);
}

PixiAssistant.prototype.firstTap = function (event) {
	this.playMp3(this.firstmp3,1);
}

PixiAssistant.prototype.standardTap = function(event) {
	this.switchTuning("standard");
}

PixiAssistant.prototype.droppedDTap = function(event) {
	this.switchTuning("droppedD");
}

PixiAssistant.prototype.proTap = function(event) {
...
PixiAssistant.prototype.playMp3 = function (file, whichString) {
...
PixiAssistant.prototype.changeOn = function(whichString) {
...
PixiAssistant.prototype.mediaReplay = function() {
...
PixiAssistant.prototype.handleCommand = function (event) {
...
PixiAssistant.prototype.launchSupportEmail = function() {
